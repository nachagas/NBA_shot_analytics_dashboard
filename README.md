...
## Problem Statement
Current defensive coverage against league MVP **Nikola Jokić** allows frequent, high-efficiency shots in the paint, resulting in a Points per Attempt (PPA) of ~1.22. The objective is to disrupt his preferred scoring areas and **lower his PPA to ≤1.00** by adjusting the defensive scheme.
